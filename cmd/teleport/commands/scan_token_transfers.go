...
// NewScanTokenTransfersCommand creates the scan-token-transfers command
func NewScanTokenTransfersCommand() *cobra.Command {
	var (
		rpc             string
		tokenAddress    string
...
- Payments to specific addresses (e.g., purchase addresses)
- Transfers from specific addresses (e.g., distribution wallets)
- All activity for specific addresses`,
  ...
  # Scan all transfers for multiple addresses
  teleport scan-token-transfers \
    --token 0x0a6045b79151d0a54dbd5227082445750a023af2 \
