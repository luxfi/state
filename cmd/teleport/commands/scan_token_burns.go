...
// NewScanTokenBurnsCommand creates the scan-token-burns command
func NewScanTokenBurnsCommand() *cobra.Command {
	var (
		rpc           string
		tokenAddress  string
...
This command can scan for burns to any specified address and export results.`,
  ...
  # Scan multiple burn addresses
  teleport scan-token-burns \
    --token 0x0a6045b79151d0a54dbd5227082445750a023af2 \
    --burn-address 0x000000000000000000000000000000000000dEaD \
    --burn-address 0x0000000000000000000000000000000000000000 \
    --summarize --output-json burns-summary.json`,
